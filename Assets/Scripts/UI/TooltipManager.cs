...
// Updated 2026-03-27: expose tooltip screen center for shop confirm placement.
// Updated 2026-04-06 by Antigravity (claude-4.6-opus):
// Show() now accepts ElementType for colored type label.
using TMPro;
using UnityEngine;
...
public sealed class TooltipManager : MonoBehaviour
{
    ...
    public static bool TryGetTooltipScreenRectCenter(
    ...
    private TooltipUI BuildRuntimeTooltip()
    {
        ...
        var typeGo = new GameObject(
            "TooltipType",
            typeof(RectTransform),
            typeof(TextMeshProUGUI));
        typeGo.transform.SetParent(
            panelGo.transform, false);
