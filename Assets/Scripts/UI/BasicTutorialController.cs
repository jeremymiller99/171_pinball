...
public sealed class BasicTutorialController : MonoBehaviour
{
    ...
    private static string firstPlayBody =>
        LocalizedUI.Get("tutorial.firstPlay.body",
            "Flippers:  Left Shift / Right Shift\n\n"
            + "Launcher:  Space\n\n"
    ...
    private static string levelUpBody =>
        LocalizedUI.Get("tutorial.levelUp.body",
            "Nice work! Click the SHOP button or press Enter whenever it is lit up. "
            + "Your current ball will be saved.");
    ...
    private static string shopBody =>
        LocalizedUI.Get("tutorial.shop.body",
            "Drag items from the right side to the board to purchase.\n\n"
            + "Change the order of balls by clicking and dragging them in the board.");
