...
// Updated with Cursor (Composer) by assistant on 2026-03-31: round type from RoundModifierController.
using System;
using UnityEngine;
...
public sealed class BoardBackgroundMaterialSwitcher : MonoBehaviour
{
    ...
    private void RefreshNow(bool force)
    {
        ...
        var roundData = ServiceLocator.Get<RoundModifierController>()?.CurrentRoundData;
        if (roundData != null)
        {
            currentType = roundData.type;
        }
